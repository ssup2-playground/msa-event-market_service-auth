...
type TokenClient interface {
	LoginToken(ctx context.Context, in *TokenLoginRequest, opts ...grpc.CallOption) (*TokenInfosResponse, error)
	RefreshToken(ctx context.Context, in *TokenRefreshRequest, opts ...grpc.CallOption) (*TokenInfoResponse, error)
}
...
func (c *tokenClient) LoginToken(ctx context.Context, in *TokenLoginRequest, opts ...grpc.CallOption) (*TokenInfosResponse, error) {
	out := new(TokenInfosResponse)
	err := c.cc.Invoke(ctx, "/Token/LoginToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokenClient) RefreshToken(ctx context.Context, in *TokenRefreshRequest, opts ...grpc.CallOption) (*TokenInfoResponse, error) {
	out := new(TokenInfoResponse)
	err := c.cc.Invoke(ctx, "/Token/RefreshToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TokenServer interface {
	LoginToken(context.Context, *TokenLoginRequest) (*TokenInfosResponse, error)
	RefreshToken(context.Context, *TokenRefreshRequest) (*TokenInfoResponse, error)
...
func _Token_LoginToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TokenServer).LoginToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Token/LoginToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenServer).LoginToken(ctx, req.(*TokenLoginRequest))
	}
...
func _Token_RefreshToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Token/RefreshToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenServer).RefreshToken(ctx, req.(*TokenRefreshRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Token_LoginToken_Handler,
		},
		{
...
func (c *userClient) UpdateUser(ctx context.Context, in *UserUpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *userClient) DeleteUser(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserMeClient interface {
	GetUserMe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserInfoResponse, error)
	UpdateUserMe(ctx context.Context, in *UserUpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	DeleteUserMe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userMeClient) GetUserMe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
...
func (c *userMeClient) UpdateUserMe(ctx context.Context, in *UserUpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *userMeClient) DeleteUserMe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserMeServer interface {
	GetUserMe(context.Context, *emptypb.Empty) (*UserInfoResponse, error)
	UpdateUserMe(context.Context, *UserUpdateRequest) (*emptypb.Empty, error)
	DeleteUserMe(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func _UserMe_GetUserMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserMeServer).GetUserMe(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserMe_DeleteUserMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserMeServer).DeleteUserMe(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
