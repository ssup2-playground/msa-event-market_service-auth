...
import (
	...
	"github.com/ssup2-playground/msa-event-market_service-auth/internal/domain"
	"github.com/ssup2-playground/msa-event-market_service-auth/internal/server/grpc_server"
	"github.com/ssup2-playground/msa-event-market_service-auth/internal/server/http_server"
)
...
func main() {
	...
	log.Info().Msg("Starting msa-event-market auth service...")
